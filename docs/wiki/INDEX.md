...
| [089-remotion-workspace-outside-build-graph.md](decisions/089-remotion-workspace-outside-build-graph.md) | `apps/video` (Remotion) staat buiten de Turborepo-build-graph via pnpm `!`-exclusie — eigen node_modules/install, raakt app-builds/deploys nooit |
