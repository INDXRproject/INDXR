...
**Library-account geseed:** `library-list` toont een archief, dus het capture-account (`account1`) heeft meerdere **schone, publieke** transcripten (colleges/talks — geen testrommel, geen persoonsgegevens). Loopt de lijst leeg of vervuild, seed opnieuw via de DB (INSERT staat in de LOG-entry 2026-08-03) — titels moeten er echt uitzien.
