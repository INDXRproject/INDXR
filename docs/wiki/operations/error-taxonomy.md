...
- **User-facing message NL:** "YouTube heeft onze verzoeken geblokkeerd. We proberen het later opnieuw."
- **User-facing message EN:** "YouTube has temporarily blocked our requests. We'll retry automatically."
...
- **User-facing message NL:** "Deze video is niet beschikbaar (verwijderd, geografisch geblokkeerd, of leeftijdsbeperking)."
- **User-facing message EN:** "This video is unavailable (removed, geo-blocked, or age-restricted)."
...
- **User-facing message NL:** "Deze video heeft een leeftijdsbeperking en is niet toegankelijk zonder YouTube-account."
- **User-facing message EN:** "This video is age-restricted and cannot be accessed without a YouTube account."
...
- **User-facing message NL:** "Deze video is exclusief voor kanaalleden en niet toegankelijk."
- **User-facing message EN:** "This video is members-only and cannot be accessed."
...
- **User-facing message NL:** "Verbinding verloren. We proberen het opnieuw."
...
- **User-facing message NL:** "Geen captions beschikbaar voor deze video. Gebruik AI-transcriptie."
- **User-facing message EN:** "No captions available for this video. Use AI transcription instead."
...
- **User-facing message NL:** "Geen spraak gedetecteerd in de audio. Controleer of de video audio bevat."
- **User-facing message EN:** "No speech detected in this audio. Please check that the video contains audio."
...
- **User-facing message EN:** "Insufficient credits. Please purchase more credits to continue."
