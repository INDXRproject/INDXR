  ...
  return (
    ...
    >
      ...
      <p>
        ...
        <Link href="/transcribe">paste any YouTube URL in the generator</Link>. For
        background on how the server-side pipeline works, see <Link href="/docs/how-indxr-works">how INDXR.AI works</Link>. For credit costs, see the <Link href="/pricing">pricing page</Link>.
      </p>
    </ArticleTemplate>
  )
}
