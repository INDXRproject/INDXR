    ...
    <>
      ...
      <DocsShell>
        ...
        <ul className="space-y-2 text-[var(--fg-subtle)] leading-relaxed">
          ...
          <li><strong className="text-[var(--fg)]">AI summary — from {summaryPer10} credit.</strong> {summaryPer10} credit per 10 minutes of video, rounded up (minimum 1); a one-hour video is {summaryCreditCost(60 * 60)} credits.</li>
