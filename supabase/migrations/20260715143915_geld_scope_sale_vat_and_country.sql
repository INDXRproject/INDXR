-- _geld_scope: BTW/measured uitsluitend uit _sale_vat; nieuw vat_by_country-blok (per land vat/gross/count/
-- rate_implied); dode kolom vat_known verwijderd (werd nergens gerenderd, alleen type-gedeclareerd).
