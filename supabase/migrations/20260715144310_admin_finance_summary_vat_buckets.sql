-- admin_finance_summary: bucket vat_by_country -> nl (eigen btw-aangifte) / oss (overige EU, Unieregeling) /
-- outside (buiten EU-scope, EUR 0) / unknown (geen land). Expliciete EU-lidstatenlijst; GB NIET (Brexit).
